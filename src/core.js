...
export async function run(args,ctx={}){
  ...
  switch(action){
    ...
    case 'official_sources':{const {listOfficialSources}=await import('./official.js');return {ok:true,sources:listOfficialSources()}}
    ...
    case 'details':{const {loadDetailedRecords}=await import('./verification-store.js');return {ok:true,records:loadDetailedRecords(workspace,{publication_numbers:args.publication_numbers||[],jurisdiction:args.jurisdiction||'',limit:args.limit||500})}}
